...
1. Improve Customer Experience: Understand customer preferences and spending behaviors through sales data analysis.
...
* Python Environment: Configured via PowerShell (`pip install Jupyter jupyter`) and launched using `python -m notebook`.
...
1. Gender: Comparing total orders and purchasing power between male and female shoppers.
